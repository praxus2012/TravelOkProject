...
namespace CapaDatos
{
    ...
    public partial class TravelOKEntitiesQA : DbContext
    {
        ...
        public virtual ObjectResult<spsObtViajeros_Result> spsObtViajeros(Nullable<int> idViaje)
        {
            var idViajeParameter = idViaje.HasValue ?
                new ObjectParameter("idViaje", idViaje) :
                new ObjectParameter("idViaje", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spsObtViajeros_Result>("spsObtViajeros", idViajeParameter);
        }
    }
}
